...
*/
    ...
    public void registerBlockIcons(IIconRegister parIIconRegister)
    {
          ...
          // 全成長段階のテクスチャを登録
          iIcon[0] = parIIconRegister.registerIcon("bountifulmod:cannabis_stage_0");
          iIcon[1] = parIIconRegister.registerIcon("bountifulmod:cannabis_stage_1");
          iIcon[2] = parIIconRegister.registerIcon("bountifulmod:cannabis_stage_2");
          iIcon[3] = parIIconRegister.registerIcon("bountifulmod:cannabis_stage_3");
