...
public class FreshCannabisBlock   extends Block implements IGrowable {
    ...
    public Item getItemDropped(int metadata, Random random, int fortune) {
    	if(metadata==1){return BountifulBlocksCore.itemDryCannabisLeaf;}
    	else{
    		return  BountifulBlocksCore.itemCannabisLeaf;}
    ...
    public void registerBlockIcons(IIconRegister parIIconRegister)
    {
          ...
          // 全成長段階のテクスチャを登録
          iIcon[0] = parIIconRegister.registerIcon("bountifulmod:freshcannabis");
          iIcon[1] = parIIconRegister.registerIcon("bountifulmod:drycannabis");
