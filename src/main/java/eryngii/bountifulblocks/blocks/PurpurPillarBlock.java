...
public class PurpurPillarBlock   extends BlockLog
{
    ...
    {
      sidetop[0] = par1IconRegister.registerIcon("bountifulmod:ppblockside");
      sidetop[1] = par1IconRegister.registerIcon("bountifulmod:ppblocktop");
    }
